...
#+RESULTS:
#+begin_example
|======================================================|100% ~0 s remaining     > # A tibble: 439,200 x 12
   Mask  Year   Day  Hour   Seq Width Height Pixels     H H.count     V V.count
   <ch> <int> <int> <int> <int> <int>  <int>  <int> <int>   <int> <dbl>   <int>
 1 Com…  2014    91    10     1  1280    960 508770     0  729544     0  726399
 2 Com…  2014    91    10     1  1280    960 508770     1       6     0       0
 3 Com…  2014    91    10     1  1280    960 508770     2     152     0       7
 4 Com…  2014    91    10     1  1280    960 508770     3     182     0      30
 5 Com…  2014    91    10     1  1280    960 508770     4     166     0      65
 6 Com…  2014    91    10     1  1280    960 508770     5     623     0      85
 7 Com…  2014    91    10     1  1280    960 508770     6     212     0     137
 8 Com…  2014    91    10     1  1280    960 508770     7     269     0     138
 9 Com…  2014    91    10     1  1280    960 508770     8     292     0     157
10 Com…  2014    91    10     1  1280    960 508770     9     801     0      49
# ... with 439,190 more rows
#+end_example
...
**** Strategy #1: 3600 bins (360 H \times 10 V)
***** Confirme we have tidy data
...
# Groups:   Mask, Year, Day, Hour, Seq, Width, Height [?]
 ...
 1 Comunidade_PEG  2014    91    10     1  1280    960 508770   3600
 2 Comunidade_PEG  2014    92    10     1  1280    960 508770   3600
 3 Comunidade_PEG  2014    93    10     1  1280    960 508770   3600
 4 Comunidade_PEG  2014    94    10     1  1280    960 508770   3600
 5 Comunidade_PEG  2014    95    10     1  1280    960 508770   3600
 6 Comunidade_PEG  2014    96    10     1  1280    960 508770   3600
 7 Comunidade_PEG  2014    97    10     1  1280    960 508770   3600
 8 Comunidade_PEG  2014    98    10     1  1280    960 508770   3600
 9 Comunidade_PEG  2014    99    10     1  1280    960 508770   3600
10 Comunidade_PEG  2014   100    10     1  1280    960 508770   3600
# ... with 112 more rows
#+end_example
...
#+begin_src R :results output :session :exports both
df.histograms %>%
    mutate(Color.Code = H+V) -> df;

df %>%
    select(-Mask, -Year, -Hour, -Seq, -Width, -Height) %>%
    filter(Day %in% c(91)) %>%
    filter(H != 0) %>%
    select(H, H.count, Pixels)
#    pull(H.count) %>% sum
#+end_src
...
**** Strategy #2: 360 bins (360 H of the most frequent V)
