...
Now, let's calculate the histograms for each picture
#+BEGIN_SRC R :session pen-2017 :results output
gethist <- function(df, vGrain=10) {
    mask <- df %>% slice(1) %>% pull(Mask.Filename);
    phenovis_read_mask(mask);
...
#+RESULTS:
#+begin_example
# A tibble: 11,847 x 16
   Name     Width Height Pixels     H Count    V0    V1    V2    V3    V4    V5
   <fct>    <int>  <int>  <int> <int> <int> <int> <int> <int> <int> <int> <int>
 1 PEN/AHS…  2272   1704 1.29e6     1     0     0     0     0     0     0     0
 2 PEN/AHS…  2272   1704 1.29e6     2     0     0     0     0     0     0     0
 3 PEN/AHS…  2272   1704 1.29e6     3     0     0     0     0     0     0     0
 4 PEN/AHS…  2272   1704 1.29e6     4     0     0     0     0     0     0     0
 5 PEN/AHS…  2272   1704 1.29e6     5     1     1     0     0     0     0     0
 6 PEN/AHS…  2272   1704 1.29e6     6    15    15     0     0     0     0     0
 7 PEN/AHS…  2272   1704 1.29e6     7     0     0     0     0     0     0     0
 8 PEN/AHS…  2272   1704 1.29e6     8     0     0     0     0     0     0     0
 9 PEN/AHS…  2272   1704 1.29e6     9     0     0     0     0     0     0     0
10 PEN/AHS…  2272   1704 1.29e6    10    11    11     0     0     0     0     0
# ... with 11,837 more rows, and 4 more variables: V6 <int>, V7 <int>,
#   V8 <int>, V9 <int>
#+end_example
